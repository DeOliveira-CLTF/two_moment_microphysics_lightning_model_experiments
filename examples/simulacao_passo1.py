...
Para rodar a partir da raiz:  python examples/simulacao_passo1.py
"""
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "fig_perfis_verticais.png", dpi=130)
plt.close()
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "fig_series_temporais.png", dpi=130)
plt.close()

print("\nFiguras salvas:")
print(" - outputs/baseline/fig_perfis_verticais.png")
print(" - outputs/baseline/fig_series_temporais.png")

# ----------------------------------------------------------------------
# 5) Dados numericos (perfis completos + series integradas), em outputs/baseline/
# ----------------------------------------------------------------------
np.savez_compressed(
    OUTPUT_DIR / "resultados_passo1.npz",
...
with open(OUTPUT_DIR / "series_passo1.csv", "w") as f:
...
print("\nDados salvos:")
print(" - outputs/baseline/resultados_passo1.npz  (perfis completos: t_s,z_m,qc,qr,Nc,Nr,qv,T_K)")
print(" - outputs/baseline/series_passo1.csv      (series integradas na coluna)")
