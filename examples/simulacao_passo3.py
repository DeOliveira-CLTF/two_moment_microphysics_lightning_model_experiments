...
Para rodar a partir da raiz:  python examples/simulacao_passo3.py
"""
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "fig_passo3_perfis.png", dpi=130)
plt.close()
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "fig_passo3_series.png", dpi=130)
plt.close()

print("\nFiguras salvas:")
print(" - outputs/baseline/fig_passo3_perfis.png")
print(" - outputs/baseline/fig_passo3_series.png")

# ----------------------------------------------------------------------
# 5) Dados numericos (perfis completos + series integradas), em outputs/baseline/
# ----------------------------------------------------------------------
np.savez_compressed(
    OUTPUT_DIR / "resultados_passo3.npz",
...
with open(OUTPUT_DIR / "series_passo3.csv", "w") as f:
...
print("\nDados salvos:")
print(" - outputs/baseline/resultados_passo3.npz  (perfis completos: t_s,z_m,qc,qr,qi,qs,qg,Nc,Nr,Ni,Ns,Ng,qv,T_K)")
print(" - outputs/baseline/series_passo3.csv      (series integradas na coluna)")
