...
Acopla o diagnostico de taxa de relampago (`lightning/lightning_mod.py`, traducao
...
Para rodar a partir da raiz:  python examples/simulacao_passo3_relampago.py
"""
...
from lightning import lightning_mod as lm
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "fig_passo3_relampago.png", dpi=130)
plt.close()

print("\nFigura salva: outputs/baseline/fig_passo3_relampago.png")

# ----------------------------------------------------------------------
# 5) Dados numericos (series de taxa de flash + gelo/neve/graupel), em outputs/baseline/
# ----------------------------------------------------------------------
np.savez_compressed(
    OUTPUT_DIR / "resultados_passo3_relampago.npz",
...
with open(OUTPUT_DIR / "series_passo3_relampago.csv", "w") as f:
...
print("\nDados salvos:")
print(" - outputs/baseline/resultados_passo3_relampago.npz")
print(" - outputs/baseline/series_passo3_relampago.csv")
